...
public class GetRecentOrdersForStoreCommandValidator : AbstractValidator<GetRecentOrdersForStoreCommand>
{
    private readonly IRepositoryManager _repositoryManager;

    public GetRecentOrdersForStoreCommandValidator(IRepositoryManager repositoryManager)
    {
